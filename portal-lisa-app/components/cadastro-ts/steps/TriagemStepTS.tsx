...
import { FuzzySliderTS } from '../FuzzySliderTS';
import { FieldGroupTS, FieldTextareaTS } from '../FormFieldsTS';
import type { DimensionKey } from '@/lib/fuzzy/types';

interface TriagemStepTSProps {
  dim: DimensionKey;
}
...
export function TriagemStepTS({ dim }: TriagemStepTSProps) {
    ...
    <div className="font-nunito">
      <div className="mb-12">
        ...
        <p className="text-lg font-light leading-relaxed text-white/80 max-w-[680px]">
          <strong className="text-white font-semibold">{meta.title}.</strong>{' '}
          {meta.intro}
        </p>
      </div>

      <div className="px-7 py-6 bg-gradient-to-br from-[rgba(12,113,195,0.10)] to-ts-mid border-l-2 border-ts-accent mb-10">
        <div className="text-[10px] font-bold uppercase tracking-[0.18em] text-ts-accent mb-2">
